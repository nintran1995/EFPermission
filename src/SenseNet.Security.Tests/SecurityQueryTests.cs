...
namespace SenseNet.Security.Tests
{
    ...
    public class SecurityQueryTests
    {
        ...
        public void Linq_All_Identities_ByPermission()
        {
            ...
            var mask1 = PermissionType.FullControl.Mask;
            var mask2 = PermissionType.FullControl.Mask;
        ...
        public void Linq_PermQuery_GetRelatedIdentities()
        {
            var ctx = CurrentContext.Security;
            ctx.CreateAclEditor()
                .Allow(Id("E1"), Id("U4"), false, PermissionType.FullControl)
                .Allow(Id("E38"), Id("U5"), false, PermissionType.FullControl)
                // additions for checking local permissions.
                .Allow(Id("E1"), Id("G6"), true, PermissionType.FullControl)
                .Allow(Id("E38"), Id("G7"), true, PermissionType.FullControl)
                // additions for checking denied permissions.
                .Deny(Id("E1"), Id("U6"), false, PermissionType.FullControl)
                .Deny(Id("E1"), Id("U7"), false, PermissionType.FullControl)
                .Apply();
            ctx.CreateAclEditor()
                .BreakInheritance(Id("E4"), new[] { EntryType.Normal })
                .Apply();
            ctx.CreateAclEditor()
                .ClearPermission(Id("E4"), Id("U4"), false, PermissionType.FullControl)
                .Apply();

            ctx.CreateAclEditor(EntryType.Sharing)
                .Allow(Id("E12"), Id("U8"), false, PermissionType.FullControl)
                .Allow(Id("E41"), Id("U8"), false, PermissionType.FullControl)
                .Allow(Id("E38"), Id("U8"), false, PermissionType.FullControl)
                .Apply();
        ...
        public void Linq_PermQuery_GetRelatedPermissions()
        {
            ...
            ctx.CreateAclEditor()
                .Allow(Id("E1"), Id("G4"), false, PermissionType.FullControl)
                .Allow(Id("E42"), Id("G4"), false, PermissionType.FullControl)
                .Apply();
            ctx.CreateAclEditor(EntryType.Sharing)
                .Allow(Id("E4"), Id("U8"), false, PermissionType.FullControl)
                .Allow(Id("E41"), Id("U8"), false, PermissionType.FullControl)
                .Apply();
        ...
        private void AddPermissionsForCategorySelectionTests(TestSecurityContext ctx)
        {
            ctx.CreateAclEditor()
                ...
                .Allow(Id("E38"), Id("U5"), false, PermissionType.FullControl)
                // additions for validating local permissions.
                .Allow(Id("E1"), Id("G6"), false, PermissionType.FullControl)
                .Allow(Id("E38"), Id("G7"), false, PermissionType.FullControl)
                .Apply();

            // add some sharing related entries
            ctx.CreateAclEditor(EntryType.Sharing)
                .Allow(Id("E4"), Id("U6"), false, PermissionType.FullControl)
                .Allow(Id("E39"), Id("U7"), false, PermissionType.FullControl)
                .Allow(Id("E4"), Id("G8"), false, PermissionType.FullControl)
                .Allow(Id("E39"), Id("G9"), false, PermissionType.FullControl)
                .Apply();
        }
        private void AddPermissionsForIdentityByPermissionTests(TestSecurityContext ctx)
        {
            var p1 = PermissionType.FullControl;
            var p2 = PermissionType.FullControl;
            ctx.CreateAclEditor()
