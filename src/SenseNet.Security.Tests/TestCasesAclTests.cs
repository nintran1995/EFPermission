...
namespace SenseNet.Security.Tests
{
    public abstract partial class TestCases
    {
        ...
        public void Acl_Get1()
        {
            ...
            SetAcl("+E1|Normal|+G1:+++++,Normal|+G2:-----");
            var acl = CurrentContext.Security.GetAcl(Id("E3"));
            Assert.AreEqual("+E3|Normal|+G1:+++++,Normal|+G2:-----", Tools.ReplaceIds(acl.ToString()));
        }
        [TestMethod]
        public void Acl_Get2()
        {
            ...
            Assert.AreEqual("+E2|Normal|+G1:+++++,Normal|+G2:+++++", Tools.ReplaceIds(acl.ToString()));
        ...
        public void Eval_HasPermission_Allow()
        {
            ...
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E1"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E1"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E1"), PermissionType.FullControl, PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E2"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E2"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E2"), PermissionType.FullControl, PermissionType.FullControl));
            foreach (var perm in PermissionType.GetPermissionTypes())
            {
                if (perm != PermissionType.FullControl && perm != PermissionType.FullControl)
                {
        ...
        public void Eval_AssertPermission()
        {
            ...
            Tools.SetMembership(CurrentContext.Security, "U1:G1,G2|U2:G1");
            SetAcl("+E1|Normal|+G1:______________+,Normal|+G2:_____________+_");
            CurrentContext.Security.AssertPermission(Id("E1"), PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(Id("E1"), PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(Id("E1"), PermissionType.FullControl, PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(Id("E2"), PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(Id("E2"), PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(Id("E2"), PermissionType.FullControl, PermissionType.FullControl);
            foreach (var perm in PermissionType.GetPermissionTypes())
            {
                if (perm != PermissionType.FullControl && perm != PermissionType.FullControl)
                {
        ...
        public void Eval_AssertPermission3()
        {
            ...
            CurrentContext.Security.AssertPermission(e1, PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(e1, PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(e1, PermissionType.FullControl, PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(e2, PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(e2, PermissionType.FullControl);
            CurrentContext.Security.AssertPermission(e2, PermissionType.FullControl, PermissionType.FullControl);
            foreach (var perm in PermissionType.GetPermissionTypes())
            {
                if (perm != PermissionType.FullControl && perm != PermissionType.FullControl)
                {
        ...
        public void Eval_HasPermission_Break()
        {
            ...
            Assert.IsFalse(CurrentContext.Security.HasPermission(Id("E2"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E2"), PermissionType.FullControl));
            Assert.IsFalse(CurrentContext.Security.HasPermission(Id("E2"), PermissionType.FullControl, PermissionType.FullControl));
        }
        [TestMethod]
        public void Eval_HasPermission_LocalOnly()
        {
            ...
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E5"), PermissionType.FullControl));
        ...
        public void Eval_HasSubtreePermission_Allow()
        {
            ...
            Assert.IsTrue(CurrentContext.Security.HasSubtreePermission(Id("E3"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasSubtreePermission(Id("E3"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasSubtreePermission(Id("E3"), PermissionType.FullControl, PermissionType.FullControl));
            ...
            //Assert.IsTrue(CurrentContext.Security.HasSubtreePermission(Id("E3"), PermissionType.FullControl));
            Assert.IsFalse(CurrentContext.Security.HasSubtreePermission(Id("E3"), PermissionType.FullControl));
            Assert.IsFalse(CurrentContext.Security.HasSubtreePermission(Id("E3"), PermissionType.FullControl, PermissionType.FullControl));
        }
        [TestMethod]
        public void Eval_HasSubtreePermission_EmptySubTree_BugReproduction()
        {
            ...
            CurrentContext.Security.CreateAclEditor()
                .Allow(Id("E1"), Id("G1"), false, PermissionType.FullControl).Apply();
            Assert.IsTrue(CurrentContext.Security.HasSubtreePermission(Id("E9"), PermissionType.FullControl));
        }
        [TestMethod]
        public void Eval_AssertSubtreePermission()
        {
            ...
            CurrentContext.Security.AssertSubtreePermission(Id("E3"), PermissionType.FullControl);
            CurrentContext.Security.AssertSubtreePermission(Id("E3"), PermissionType.FullControl);
            CurrentContext.Security.ModifyEntityOwner(Id("E3"), differentOwnerId);
            try
            {
                CurrentContext.Security.AssertSubtreePermission(Id("E3"), PermissionType.FullControl, PermissionType.FullControl);
            }
            finally
            {
            ...
            try
            {
                CurrentContext.Security.ModifyEntityOwner(Id("E3"), differentOwnerId);
                CurrentContext.Security.AssertSubtreePermission(Id("E3"), PermissionType.FullControl, PermissionType.FullControl);
                Assert.Fail("FullControl+Edit subtree permission on E3 is true, expected: false.");
            }
            catch { }
            finally
            {
        ...
        public void Eval_AssertSubtreePermission_Entity()
        {
            ...
            CurrentContext.Security.AssertSubtreePermission(e3, PermissionType.FullControl);
            CurrentContext.Security.AssertSubtreePermission(e3, PermissionType.FullControl);
            CurrentContext.Security.AssertSubtreePermission(e3, PermissionType.FullControl, PermissionType.FullControl);
        ...
        public void Eval_GetSubtreePermission_BreakAllowLocalonly()
        {
            ...
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E21"), PermissionType.FullControl));
            Assert.IsFalse(CurrentContext.Security.HasPermission(Id("E22"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasPermission(Id("E29"), PermissionType.FullControl));

            // main tests
            Assert.IsFalse(CurrentContext.Security.HasSubtreePermission(Id("E8"), PermissionType.FullControl));
            Assert.IsTrue(CurrentContext.Security.HasSubtreePermission(Id("E29"), PermissionType.FullControl));
        }
        ...
        public void AclEditor_PermissionBitMask1()
        {
            ...
            pbm = PermissionType.FullControl;
            Assert.AreEqual(PermissionType.FullControl.Mask, pbm.AllowBits);
            Assert.AreEqual(0u, pbm.DenyBits);

            pbm = ~PermissionType.FullControl;
            Assert.AreEqual(0u, pbm.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask, pbm.DenyBits);

            pbm = PermissionType.FullControl | PermissionType.FullControl;
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, pbm.AllowBits);
            Assert.AreEqual(0u, pbm.DenyBits);
            ...
            pbm = ~PermissionType.FullControl | ~PermissionType.FullControl;
            Assert.AreEqual(0u, pbm.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, pbm.DenyBits);

            pbm = PermissionType.FullControl | PermissionType.FullControl | PermissionType.FullControl | ~PermissionType.FullControl | ~PermissionType.FullControl;
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, pbm.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, pbm.DenyBits);
        }
        ...
        public void AclEditor_AllowDenyMoreBits()
        {
            ...
            ed.Allow(entityId, userId1, false, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl);
            ed.Allow(entityId, userId2, false, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl);
            ed.Allow(entityId, userId1, true, PermissionType.FullControl, PermissionType.FullControl);
            ed.Allow(entityId, userId2, true, PermissionType.FullControl, PermissionType.FullControl);
            ed.Deny(entityId, userId1, false, PermissionType.FullControl, PermissionType.FullControl);
            ed.Deny(entityId, userId2, false, PermissionType.FullControl, PermissionType.FullControl);
            ed.Deny(entityId, userId1, true, PermissionType.FullControl, PermissionType.FullControl);
            ed.Deny(entityId, userId2, true, PermissionType.FullControl, PermissionType.FullControl);
            ...
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace1.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace1.DenyBits);

            Assert.AreEqual(userId2, ace2.IdentityId);
            Assert.AreEqual(false, ace2.LocalOnly);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace2.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace2.DenyBits);

            Assert.AreEqual(userId1, ace3.IdentityId);
            Assert.AreEqual(true, ace3.LocalOnly);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace3.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace3.DenyBits);

            Assert.AreEqual(userId2, ace4.IdentityId);
            Assert.AreEqual(true, ace4.LocalOnly);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace4.AllowBits);
            Assert.AreEqual(PermissionType.FullControl.Mask | PermissionType.FullControl.Mask, ace4.DenyBits);
        }
        [TestMethod]
        ...
        public void AclEditor_SetMoreBits()
        {
            ...
            //#
            ed.Set(entityId, userId1, false, PermissionType.FullControl | PermissionType.FullControl | PermissionType.FullControl | ~PermissionType.FullControl | ~PermissionType.FullControl);
            ed.Set(entityId, userId2, false, PermissionType.FullControl | PermissionType.FullControl | PermissionType.FullControl | ~PermissionType.FullControl | ~PermissionType.FullControl);
            ed.Set(entityId, userId1, true, PermissionType.FullControl | PermissionType.FullControl | ~PermissionType.FullControl | ~PermissionType.FullControl);
            ed.Set(entityId, userId2, true, PermissionType.FullControl | PermissionType.FullControl | ~PermissionType.FullControl | ~PermissionType.FullControl);
        ...
        public void AclEditor_AllowMoreEntriesInOneEditor()
        {
            ...
            ed.Allow(entityId1, userId1, false, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl);
            ed.Allow(entityId1, userId2, false, PermissionType.FullControl);
            ed.Allow(entityId2, userId1, false, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl);
            ed.Apply();
        ...
        public void AclEditor_RemovePermissions()
        {
            ...
            //#
            ed = CurrentContext.Security.CreateAclEditor();
            ed.ClearPermission(entityId2, userId1, false, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl);
            ed.Apply();
        ...
        public void AclEditor_ResetPermissions()
        {
            ...
            //#
            ed = CurrentContext.Security.CreateAclEditor();
            ed.Reset(entityId2, userId1, false, PermissionType.FullControl | PermissionType.FullControl | PermissionType.FullControl | PermissionType.FullControl);
            ed.Apply();
