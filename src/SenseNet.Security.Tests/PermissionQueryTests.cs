...
namespace SenseNet.Security.Tests
{
    ...
    public class PermissionQueryTests
    {
        ...
        {
            var perms = new[] { PermissionType.FullControl };
            ...
            perms = new[] { PermissionType.FullControl };
            ...
            perms = new[] { PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl };
            result = CurrentContext.Security.GetRelatedEntities(Id("E3"), PermissionLevel.AllowedOrDenied, true, Id("U1"), perms);
            actual = string.Join(", ", result.OrderBy(x => x));
        ...
        public void PermissionQuery_GetRelatedItemsOneLevel()
        {
            ...
            var permissionTypes = new[] { PermissionType.FullControl, PermissionType.FullControl, PermissionType.FullControl };
        ...
        {
            {"P1", PermissionType.FullControl},
            {"P2", PermissionType.FullControl},
            {"P3", PermissionType.FullControl},
            {"P4", PermissionType.FullControl},
            {"P5", PermissionType.FullControl},
            {"P6", PermissionType.FullControl},
        };
