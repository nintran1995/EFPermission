...
namespace SenseNet.Security.Tests.Concurrency
{
    class Program
    {
        ...
        private static void RunACL(ProgramArguments arguments)
        {
            ...
            var ok = ctx.HasPermission(1, PermissionType.FullControl);
            AclEditor.Create(ctx)
                .Allow(1, TestUser.User3.Id, false, PermissionType.FullControl)
                .Allow(2, TestUser.User3.Id, false, PermissionType.FullControl)
                .Allow(5, TestUser.User3.Id, false, PermissionType.FullControl)
                .Allow(14, TestUser.User3.Id, false, PermissionType.FullControl)
                .Allow(50, TestUser.User3.Id, false, PermissionType.FullControl)
                .Allow(51, TestUser.User3.Id, false, PermissionType.FullControl)
                .Allow(52, TestUser.User3.Id, false, PermissionType.FullControl)
                .Apply();
            ok = ctx.HasPermission(52, PermissionType.FullControl);
        ...
        private static void ACLExercise1(int id)
        {
            ...
            while (!_stopped)
            {
                ...
                var ok = ctx.HasPermission(52, PermissionType.FullControl);
        ...
        private static void ACLExercise2(int id)
        {
            ...
            var count = 0;
            var permTypes = new[]{PermissionType.FullControl, PermissionType.FullControl};
            while (!_stopped)
            {
                Thread.Sleep(10);
        ...
        private static void DELETECheckPermission(int id)
        {
            ...
            while (!_stopped)
            {
                try
                {
                    var hp = ctx.HasPermission(eid, PermissionType.FullControl);
                    if (hp)
                        errors++;
